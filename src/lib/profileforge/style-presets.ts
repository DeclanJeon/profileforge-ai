...
export const CAMERA_SHOT_PRESETS: CameraShotPreset[] = [
  ...
  { id: 'camera-over-shoulder', name: '오버숄더', category: 'Cinematic', description: '어깨 너머로 바라보는 시네마틱 구도', tags: ['오버숄더', '시네마', '스토리'], prompt: 'over-the-shoulder portrait framing, face turned back toward camera, visible shoulder line, cinematic depth and environmental context', recommendedAspect: '4:5' },
  { id: 'camera-mirror-selfie', name: '미러 셀피 프레이밍', category: 'Social', description: '거울 셀피처럼 자연스러운 SNS 구도', tags: ['미러', '셀피', 'SNS'], prompt: 'mirror-selfie style framing, natural handheld energy without showing a phone logo, casual upright posture, lifestyle social crop', negative: 'unreadable face, brand logos on phone', recommendedAspect: '1:1' },
  { id: 'camera-seated-desk', name: '시티드 데스크 3/4', category: 'Lifestyle', description: '책상이나 테이블에 앉은 3/4 라이프스타일 구도', tags: ['좌식', '데스크', '라이프'], prompt: 'seated three-quarter desk portrait, natural lean or rest of arms, environmental desk context softly blurred, approachable lifestyle composition', recommendedAspect: '4:5' },
  { id: 'camera-side-profile', name: '사이드 프로필', category: 'Portrait', description: '얼굴 측면 라인의 순수 프로필 구도', tags: ['측면', '실루엣', '클래식'], prompt: 'true side-profile portrait, clean facial silhouette, elegant neck line, classic photography composition with balanced negative space', recommendedAspect: '4:5' },
  { id: 'camera-environmental-wide', name: '환경형 와이드', category: 'Environmental', description: '공간 분위기가 함께 보이는 넓은 환경 초상', tags: ['환경', '와이드', '로케이션'], prompt: 'environmental wide portrait, subject clearly readable with generous scene context, lifestyle location storytelling, balanced headroom and foot room if needed', recommendedAspect: '16:9' },
  { id: 'camera-hands-in-frame', name: '핸즈 인 프레임', category: 'Editorial', description: '손 제스처가 보이는 상반신 에디토리얼 구도', tags: ['손', '제스처', '화보'], prompt: 'waist-up editorial framing with natural hands-in-frame gesture, elegant posture, fashion-aware composition while keeping face primary', negative: 'extra fingers, deformed hands, fused fingers', recommendedAspect: '4:5' },
]
